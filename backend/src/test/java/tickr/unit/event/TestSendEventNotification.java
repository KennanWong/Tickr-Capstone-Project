...
import tickr.application.serialised.requests.event.EventNotificationsUpdateRequest;
...
public class TestSendEventNotification {
    ...
    public void testEventEditEmail() {
        ...
        controller.editEvent(session, new EditEventRequest(eventId, hostToken, null, null, null, "2031-12-04T10:15:30Z","2031-12-05T10:15:30Z",
        ...
        msg = emailAPI.getSentMessages().get(1);
        assertEquals("test@example.com", msg.getToEmail());
        assertEquals("Test Event Name Changes", msg.getSubject());
        assertTrue(msg.getBody().contains("made a change in"));
    }
